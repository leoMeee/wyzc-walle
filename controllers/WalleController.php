    ...
    public function actionDetection($projectId)
    {
        ...
        try {
            ...
            if (!$isWritable) {
                ...
                $log[] = yii::t(
                    'walle',
                    'hosted server is not writable error',
                    [
                        'user' => getenv("USER"),
        ...
        try {
            ...
            if (!$ret) {
                ...
                $log[] = yii::t(
                    'walle',
                    'target server is not writable error',
                    [
                        'remote_user' => $project->release_user,
                        'path' => $project->release_to,
                    ]
